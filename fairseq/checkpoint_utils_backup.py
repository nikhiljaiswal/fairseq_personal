...
def load_checkpoint_to_cpu(path, arg_overrides=None):
    ...
    if not hasattr(state["args"], "arch"):
        # Set to the correct architecture used during training. Likely one of:
        # "transformer", "transformer_iwslt_de_en", "mbart_large", etc.
        # Update based on your actual model used.
        setattr(state["args"], "arch", "transformer")
